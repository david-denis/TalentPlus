...
namespace TalentPlus.Shared
{
	public class CustomEntry : Entry
	{
		...
		public static readonly BindableProperty PlaceholderTextColorProperty =
			BindableProperty.Create("PlaceholderTextColor", typeof(Color), typeof(CustomEntry), Xamarin.Forms.Color.Default);
		...
		/// </summary>
		public Xamarin.Forms.Color PlaceholderTextColor
		{
            get { return (Xamarin.Forms.Color)GetValue(PlaceholderTextColorProperty); }
