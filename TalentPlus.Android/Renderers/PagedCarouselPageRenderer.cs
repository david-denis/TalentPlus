...
namespace CaveBirdLabs.Forms.Platform.Android
{
	public class CxPagedCarouselPageRenderer : CarouselPageRenderer
	{
		...
		protected override void OnElementPropertyChanged (object sender, PropertyChangedEventArgs e)
		{
			...
			case "IsPagerVisible":
				_viewPager.Visibility = _pagedCarouselPage.IsPagerVisible ? ViewStates.Visible : ViewStates.Invisible;
				break;
			case "PagerItemColor":
		...
		{
			_circlePageIndicator.PageColor = _pagedCarouselPage.SelectedPagerItemColor != Color.Default ? _pagedCarouselPage.SelectedPagerItemColor.ToAndroid () : global::Android.Graphics.Color.Black;
		}

		private void SetPageIndicatorTintColor ()
		{
			_circlePageIndicator.FillColor = _pagedCarouselPage.PagerItemColor != Color.Default ? _pagedCarouselPage.PagerItemColor.ToAndroid () : global::Android.Graphics.Color.Gray;
		}
